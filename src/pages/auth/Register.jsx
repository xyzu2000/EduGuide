            ...
            <div className="p-4 lg:p-8 bg-zinc-100 rounded-lg mt-8 w-full md:max-w-[600px]">
                ...
                <form className="space-y-6" onSubmit={handleSignUp}>
                    <div>
                        ...
                        <label
                            for="dropzone-file"
                            class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50  hover:bg-zinc-50 "
                        >
